...
using Spectara.Revela.Plugins.Core.Projects.Commands;
using Spectara.Revela.Sdk.Abstractions;

namespace Spectara.Revela.Plugins.Core.Projects;
...
public sealed class ProjectsPlugin : IPlugin
{
    ...
    {
        Id = "Spectara.Revela.Plugins.Core.Projects",
        Name = "Projects",
        Version = "1.0.0",
    ...
    public IEnumerable<CommandDescriptor> GetCommands(IServiceProvider services)
    {
        ...
        if (!Revela.Core.Services.ConfigPathResolver.IsStandaloneMode)
        {
            yield break;
        }
